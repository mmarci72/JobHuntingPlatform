...
export class AuthService {
	...
	constructor(
		private readonly keycloakService: KeycloakService, private readonly sessionStorageService: SessionStorageService,
		private readonly http: HttpClient, private readonly userNotificationService: UserNotificationService,
	...
	public async saveUser() {
		...
		user = await lastValueFrom(this.http.get<User>(`http://localhost:8080/user/${user.username}`));
